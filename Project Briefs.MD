...
|고객| 저희의 고객은 해외 유명 미술관, 박물관 등 전시 작품을 감상하는데 어려움을 겪고 있는 20대 한국인 여행객입니다. <br> 페르소나:<br>
- 이름: 김한글
- 나이: 24살
- 성별: 여자
- 특징: 방학을 맞아 홀로 유럽 여행 중이며, 미술 작품 감상에 관심이 많아 여러 유명 미술관, 박물관을 돌아보고 있다. 미술에 조예가 깊지 않아, 미술관에서 제공하는 오디오 가이드를 항상 사용하고 있는데, 한국어 언어 지원이 안되는 경우가 많아 영어로 작품 해설을 듣게 되는 경우가 많다. 하지만 영어를 어려워해, 작품 해설을 이해하는데 어려움을 겪고 있다. |
|Pain Point| 1. 한국어 작품 해설의 부재 
<br> - 가이드 없이 자유여행을 즐기는 20대 여행객들은 미술관에 방문했을 때 작품 감상에 어려움을 겪습니다.
<br> 2. 오디오 가이드의 퀄리티 부족
<br> - 미술관에 오디오 가이드가 존재하하더라도, 한국어 오디오 가이드가 없거나, 번역이 어색해 오히려 작품 감상에 불편함을 겪습니다. |
|기술 솔루션 서술| YOLO를 사용해 사진에서 그림 이미지를 추출한다.
<br>RAG를 사용해 사용자에게 단순히 그림에 대한 해설을 제공하는 것뿐만 아니라 사용자 검색 기록을 기반으로 맞춤화 된 작품 추천 서비스를 제공한다.
<br>OpenAI를 AI가 작품 설명을 자동 생성하도록 활용한다. 
<br> CLIP을 사용해 사진 이미지가 주어지면 가장 관련성이 높은 작품 설명 텍스트를 예측하도록 한다.|
